...
var partialSearchUrl = 'https://www.dislicores.com/busca/?';
...
function onSearchNavigatorButtonClick(sender) {
    ...
    var separator = '&';
    var newFilters = '';
    var newPathAndQuery = 'https://www.dislicores.com/busca/';
    ...
    if (sender.pathname.length > 0) {
        currentPathAndQuery = sender.pathname.indexOf('https://www.dislicores.com/') == 0 ? sender.pathname : '/' + sender.pathname;
